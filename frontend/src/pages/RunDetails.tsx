    ...
    for (let tab in SidePanelTab) {
      ...
      switch (+tab) {
        case SidePanelTab.INPUT_OUTPUT: {
          tabNameList.push(t('inputOutput'));
          break;
        }
        case SidePanelTab.VISUALIZATIONS: {
          tabNameList.push(t('visualizations'));
          break;
        }
        case SidePanelTab.ML_METADATA: {
          ...
          tabNameList.push(t('mlMetadata'));
          break;
        }
        case SidePanelTab.TASK_DETAILS: {
          tabNameList.push(t('details'));
          break;
        }
        case SidePanelTab.VOLUMES: {
          tabNameList.push(t('volumes'));
          break;
        }
        case SidePanelTab.LOGS: {
          tabNameList.push(t('logs'));
          break;
        }
        case SidePanelTab.POD: {
          tabNameList.push(t('pod'));
          break;
        }
        case SidePanelTab.EVENTS: {
          tabNameList.push(t('events'));
          break;
        }
  ...
  public async load(): Promise<void> {
    ...
    try {
      ...
      const graph =
        ...
        // TODO: add a comment about the need for translation of Description.
          ? WorkflowParser.createRuntimeGraph(t, workflow, mlmdExecutions)
          : undefined;
